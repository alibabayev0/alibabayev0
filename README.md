...
### :rocket: About:
>Hello, I'm Ali, a 22-year-old Senior Software developer from Azerbaijan. My primary expertise lies in crafting Android applications using Java and Kotlin, a domain in which I've garnered substantial experience and skill. Beyond Android, I also possess a comprehensive proficiency in other technical realms. This includes adeptness in languages like C, C++, Python, C#, and Java. On the web front, I'm well-versed in front-end technologies encompassing HTML, CSS, and JavaScript, as well as frameworks such as jQuery, Ajax, Vue.js, React.js and etc. As a full-stack aficionado, I delve into backend development using Node.js and PHP. My database knowledge spans both SQL-based platforms like MySQL and MSSQL and NoSQL. Always on the lookout for new challenges, I'm eager to collaborate and contribute to innovative projects.
### :milky_way:Find me:
<p float="left">
