...
### :rocket: About:
>My name is Ali.I'm from Azerbaijan and 20 years old. Sr. programmer specializing in Android && Backend. Experienced with all stages of the development cycle for dynamic projects. Well-versed in numerous programming languages C & C++, Python, C# (.NET & ASP.NET), Android SDK(Java & Kotlin), Frontend (HTML, CSS, JS (jQuery, Ajax, Vue.js, & etc)), Backend (Node.js - Express.js & Koa.js), T-SQL (MySQL & MSSQL), NoSQL (MongoDB)
### :milky_way:Find me:
<p float="left">
